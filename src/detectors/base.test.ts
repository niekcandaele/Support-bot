...
describe('DETECTOR base', function () {
    ...
    it('Replies to the text', async function () {
        ...
        await detector.handleMessage({ content: 'before test-regex after', reply: replySpy } as unknown as Message);
        ...
        await detector.handleMessage({ content: 'Not a valid player profile', reply: replySpy } as unknown as Message);
